...
in
{
  ...
  programs.zen-browser = {
    ...
    policies = {
      ...
      ExtensionSettings =
        let
          forceInstalled = builtins.mapAttrs (_: install_url: {
            inherit install_url;
          ...
          sideloadedIds = with addons; map (p: p.addonId) [
            ublock-origin
            bitwarden
          ...
          allowPrivate = builtins.listToAttrs (map (id: {
            name = id;
            value = {
